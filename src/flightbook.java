...
public class flightbook extends javax.swing.JFrame {
    ...
    public flightbook() {
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select *from ticket_details");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("All Employee Deteils");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new flightbook().setVisible(true);
            }
        });
    }
